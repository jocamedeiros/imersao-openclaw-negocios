...
## 2. Mapeamento Pessoa → Agentes Permitidos
...
| 444444444 | Diana Rocha | Social Media | Assistente Geral |
| 555555555 | Eduardo Silva | Suporte | Assistente Geral |
| 666666666 | Visitante / Aluno | — | Nenhum (somente leitura) |

### Níveis de acesso

- **Todos** → pode falar com qualquer agente, ver qualquer dado
...
2. **Pessoa só aciona agentes que tem permissão** — o resto ignora
3. **Ações sensíveis pedem confirmação** (emails, posts públicos, alterações de preço) independente do nível de acesso
